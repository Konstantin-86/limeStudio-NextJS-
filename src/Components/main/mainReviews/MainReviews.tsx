...
import arrowRight from "@/images/mainReviews/arrow-right.png";
          ...
          <div className={styles.inner}>
            <div className={`${styles.item} ${styles.itemContent}`}>
              ...
              <div className={styles.text}>
                <p>
                  Всем добрый день! Планируя ремонт в квартире, мы особое
                  внимание уделили детской, поскольку у нас разнополые дети и
                  хотелось бы, что бы комната была максимально функциональна,
                  комфорта и, в то же время, оставалась просторной,
                  лаконичной...
                </p>
              </div>
            ...
            <div className={`${styles.item} ${styles.itemContent}`}>
              ...
              <div className={styles.text}>
                <p>
                  В компанию Lime я обратился по просьбе жены, которая не в
                  силах была продумать дизайн интерьера квартиры. А ремонт
                  требовался, и капитальный, поэтому хотелось сделать все как
            ...
            <div className={`${styles.item} ${styles.itemContent}`}>
              <h3 className={styles.itemTitle}>1000+</h3>
              <p className={styles.itemText}>
                Отзывов на <span>Яндекс</span> Картах!
              </p>
